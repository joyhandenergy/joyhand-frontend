...
export const productData = [
  {
    ...
    images: [
      "/images/solarImg/panel.home.jpg",
      "/images/solarImg/inverter-2.jpg",
      "/images/solarImg/inverter-3.jpg"
    ],
    description: "High-efficiency pure sine wave inverter designed for heavy-duty industrial power backup systems. It features advanced cooling and smart monitoring.",
    specifications: [
      { label: "Rated Power", value: "5000W" },
      { label: "DC Input", value: "48VDC" },
      { label: "AC Output", value: "230VAC, 50/60Hz" },
      { label: "Peak Efficiency", value: "93%" },
      { label: "Protection", value: "IP65 Waterproof" },
      { label: "Communication", value: "RS485 / WiFi / GPRS" }
    ]
  },
  {
    id: 2,
